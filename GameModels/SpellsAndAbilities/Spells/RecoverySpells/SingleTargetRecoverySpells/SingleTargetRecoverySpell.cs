...
public class SingleTargetRecoverySpell : RecoverySpell
{
    public SingleTargetRecoverySpell(string name, string school, int level, int cost) : base(name, school, level, cost)
    {
        Name = name;
        SpellSchool = school;
        SpellLevel = level;
