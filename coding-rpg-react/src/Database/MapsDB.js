import { banditHideout, bridge, brokenBridge, daleTown, dwarvenMine, farm, forest, fortDale, giantCave,lake, littleRootFarm, lumbermill,mill, mountains, orcVillage, river, road, spiderCave, tenguCamp, whiteScalesLair, witchHut } from "./LocationsDB"
...
export function worldMap(hero) {
    var worldMap = {
        Name: "World", Locations: [
            mountains(hero, 4, 15), mountains(hero, 5, 15),
            road (hero, -2, 14), road(hero, -1, 14),orcVillage(hero, 0, 14), road (hero, 1, 14),whiteScalesLair(hero, 4, 14), mountains(hero, 5, 14),
            road(hero, -3, 13), road(hero, -2, 13), lake(hero, -1, 13), lake(hero, 0, 13),road(hero, 1, 13), road(hero, 2, 13),farm(hero, 4, 13), mountains(hero, 5, 13),
            ...
            road(hero, -1, 6), river(hero, 1, 6), river(hero, 2, 6),
            road(hero, -1, 5), forest(hero, 0, 5), forest(hero, 1, 5), river(hero, 2, 5), mountains(hero, 4, 5), mountains(hero, 5, 5),
            road(hero, -1, 4), road(hero, 0, 4), lumbermill(hero, 1, 4), bridge(hero, 2, 4), forest(hero, 3, 4), giantCave(hero, 4, 4), mountains(hero, 5, 4),
            ...
            forest(hero, -4, -1), tenguCamp(hero, -3, -1), river(hero, -2, -1), littleRootFarm(hero, -1, -1), road(hero, 0, -1), farm(hero, 1, -1), forest(hero, 2, -1), forest(hero, 3, -1), mountains(hero, 4, -1), mountains(hero, 5, -1),
            forest(hero, -4, -2), forest(hero, -3, -2), river(hero, -2, -2),mill(hero, -1, -2), road(hero, 0, -2), road(hero, 1, -2), forest(hero, 2, -2), forest(hero, 3, -2), mountains(hero, 4, -2), mountains(hero, 5, -2),
            forest(hero, -4, -3), spiderCave(hero, -3, -3), river(hero, -2, -3),farm(hero, -1, -3), road(hero, 1, -3), road(hero, 2, - 3), dwarvenMine(hero, 3, -3), mountains(hero, 4, -3), mountains(hero, 5, -3),
...
//|- 16  -||       ||       ||       ||       ||       ||       ||       ||       ||       ||       ||       |                                    
//|- 15  -||       ||       ||       ||       ||       ||       ||       ||       ||       ||mtn    ||mtn    |                                    
//|- 14  -||       ||       ||       ||  road || road  || orc   || road  ||       ||       ||lair   ||mtn    |         
//|- 13  -||       ||       ||  road ||  road || lake  || lake  || road  || road  ||       || farm  ||mtn    |
...
//|-  6  -||       ||       ||       ||       ||  rd   ||       ||  rvr  ||  rvr  ||       ||       ||       |
//|-  5  -||       ||       ||       ||       ||  rd   ||  for  ||  for  || rvr   ||       ||  mtn  ||  mtn  |
//|-  4  -||       ||       ||       ||       ||  rd   ||  rd   || mill  ||  brdg ||  for  || gcave ||  mtn  |
...
//|- -1  -||       || for   || crow  || rvr   ||lrfarm ||  rd   || farm  || for   || for   || mtn   ||  mtn  |
//|- -2  -||       || for   || for   || rvr   ||mill   ||  rd   ||  rd   || rvr   || for   ||  mtn  ||  mtn  |
//|- -3  -||       || for   || spdr  || rvr   ||farm   ||       ||  rd   ||  rd   || mine  ||  mtn  ||  mtn  |
