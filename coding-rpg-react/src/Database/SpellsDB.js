...
export function poisonSpray() {
    var poisonSpray = {
        Name: "Poison Spray", School: new AlterationSkill(), LevelRequirement: 1, Use: "Combat", ManaCost: 10, Description: "A Spray of Poison that Poisons all Foes", Amount: 5, DamageType: new PoisonDamage(),
        SpellEffect(char, allies, enemies, target, combatLog) {
            ...
            for (var e = 0; e < enemies.length; e++) {
                ApplyCondition(enemies[e],
                    new PoisonCondition(this.Amount, calcDuration),
                    combatLog);
            }
        }
    }
...
export function summonRat() {
    var summonRat = {
        Name: "Summon Rat", School: new ConjurationSkill(), LevelRequirement: 1, Use: "Combat", ManaCost: 5, Description: "Summons a Rat to fight", Summon: new Rat(),
        SpellEffect(char, allies, enemies, target, combatLog) {
...
export function summonSkeleton() {
    var summon = {
        Name: "Summon Skeleton", School: new ConjurationSkill(), LevelRequirement: 10, Use: "Combat", ManaCost: 10, Description: "Summons a Skeleton to fight", Summon: new Skeleton(),
        SpellEffect(char, allies, enemies, target, combatLog) {
            AddToCombatLog(combatLog, char.Name + " summons a " + this.Summon.Name);
            ModifySummon(char, allies, this.Summon)
        }
...
export function summonSpider() {
    var summon = {
        Name: "Summon Spider", School: new ConjurationSkill(), LevelRequirement: 1, Use: "Combat", ManaCost: 5, Description: "Summons a spider to fight", Summon: new Spider(),
        SpellEffect(char, allies, enemies, target, combatLog) {
            AddToCombatLog(combatLog, char.Name + " summons a " + this.Summon.Name);
            ModifySummon(char, allies, this.Summon)
        }
...
export function webSpell() {
    var web = {
        Name: "Sleep", School: new ConjurationSkill(), LevelRequirement: 1, Use: "Combat", ManaCost: 10, Description: "Webs all foes", Amount: 0, DamageType: new NoDamage(),
        SpellEffect(char, allies, enemies, target, combatLog) {
            var calcDuration = CalculateSpellBonus(char, this, char.Attributes.Intelligence.Value, char.Attributes.Intelligence.Bonus, char.Attributes.Intelligence.Penalty, 3);
...
export function fireBall() {
    var fireBall = {
        Name: "Fire Ball", School: new DestructionSkill(), LevelRequirement: 10, Use: "Combat", ManaCost: 10, Description: "Ball of Fire that deals 10 Fire Damage to All Foes", Amount: 10, DamageType: new FireDamage(this),
...
export function magicMissile() {
    var magicMissile = {
        Name: "Magic Missile", School: new DestructionSkill(), LevelRequirement: 1, Use: "Combat", ManaCost: 5, Description: "Missile of Magical Force that deals 5 Force Damage to One Foe", Amount: 5, DamageType: new ForceDamage(this),
        SpellEffect(char, allies, enemies, target, combatLog) {
...
export function inspireCourage() {
    var inspireCourage = {
        Name: "Inspire Courage", School: new IllusionSkill(), LevelRequirement: 1, Use: "Combat", Amount: 1, ManaCost: 5, Description: "Inspires one ally, increasing their damage",
        SpellEffect(char, allies, enemies, target, combatLog) {
...
export function sleepSpell() {
    var sleep = {
        Name: "Sleep", School: new IllusionSkill(), LevelRequirement: 10, Use: "Combat", ManaCost: 10, Description: "Puts all foes to sleep", Amount: 0, DamageType: new NoDamage(),
        SpellEffect(char, allies, enemies, target, combatLog) {
            var calcDuration = CalculateSpellBonus(char, this, char.Attributes.Charisma.Value, char.Attributes.Charisma.Bonus, char.Attributes.Charisma.Penalty, 3);
...
export function bane() {
    var bane = {
        Name: "Bane", School: new RestorationSkill(), LevelRequirement: 1, Use: "Combat", Amount: 3, ManaCost: 10, Description: "Weakens all Foes",
        SpellEffect(char, allies, enemies, target, combatLog) {
...
export function basicHeal() {
    var basicHeal = {
        Name: "Basic Heal", School: new RestorationSkill(), LevelRequirement: 1, Use: "Hybrid", Amount: 5, ManaCost: 5, Description: "Heals One Ally for 5HP",
        SpellEffect(char, allies, enemies, target, combatLog) {
...
export function basicMassHeal() {
    var basicHeal = {
        Name: "Basic Mass Heal", School: new RestorationSkill(), LevelRequirement: 10, Use: "Hybrid", Amount: 5, ManaCost: 5, Description: "Heals All Allies for 5HP",
        SpellEffect(char, allies, enemies, target, combatLog) {
            var totalHeal = CalculateSpellBonus(char, this, char.Attributes.Wisdom.Value, char.Attributes.Wisdom.Bonus, char.Attributes.Wisdom.Penalty, this.Amount);
...
export function bless() {
    var bless = {
        Name: "Bless", School: new RestorationSkill(), LevelRequirement: 1, Use: "Combat", Amount: 3, ManaCost: 10, Description: "Blesses all Allies, Strengthening Them",
        SpellEffect(char, allies, enemies, target, combatLog) {
...
export function curePoison() {
    var curePoison = {
        Name: "Cure Poison", School: new RestorationSkill(), LevelRequirement: 1, Use: "Hybrid", ManaCost: 5, Description: "Cures One Ally of Poison",
        SpellEffect(char, allies, enemies, target, combatLog) {
...
export function heroism() {
    var heroism = {
        Name: "Heroism", School: new RestorationSkill(), LevelRequirement: 1, Use: "Combat", Amount: 1, ManaCost: 5, Description: "Gives one all Allies Temp HP",
        SpellEffect(char, allies, enemies, target, combatLog) {
            var calcBuff = CalculateSpellBonus(char, this, char.Attributes.Wisdom.Value, char.Attributes.Wisdom.Bonus, char.Attributes.Wisdom.Penalty, this.Amount);
