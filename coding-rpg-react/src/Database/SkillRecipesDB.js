...
export class CookBeefStew extends CookingRecipe {
    constructor(name = "Cook Beef Stew", level = 5, xp = 125, input = [{ Item: new RawBeef(), Quantity: 1 }, { Item: new Milk(), Quantity: 1 }], output = { Item: new BeefStew(), Quantity: 1 }, failure = { Item: new BurntStew(), Quantity: 1 }) {
        super(name, level, xp, input, output, failure)
    }
}
export class CookFishStew extends CookingRecipe {
    constructor(name = "Cook Fish Stew", level = 5, xp = 125, input = [{ Item: new RawFish(), Quantity: 1 }, { Item: new Milk(), Quantity: 1 }], output = { Item: new FishStew(), Quantity: 1 }, failure = { Item: new BurntStew(), Quantity: 1 }) {
        super(name, level, xp, input, output, failure)
    }
}
...
export class CookRatStew extends CookingRecipe {
    constructor(name = "Cook Rat Stew", level = 5, xp = 125, input = [{ Item: new RawRatMeat(), Quantity: 1 }, { Item: new Milk(), Quantity: 1 }], output = { Item: new RatStew(), Quantity: 1 }, failure = { Item: new BurntStew(), Quantity: 1 }) {
        super(name, level, xp, input, output, failure)
    }
}
...
export function craftingRecipes() {
    ...
    new WeaveSpiderSilkBoots(), new WeaveSpiderSilkGloves(), new WeaveSpiderSilkRobeBottom(), new WeaveSpiderSilkRobeTop(), new WeaveSpiderSilkWizardHat(),
    new WeaveWoolBoots(), new WeaveWoolGloves(), new WeaveWoolHat(), new WeaveWoolRobeBottom(), new WeaveWoolRobeTop(), new WeaveWoolTrousers(), new WeaveWoolTunic(), new WeaveWoolWizardHat()]
    return craft;
}
...
export function fletchingRecipes() {
    ...
    new FletchOakLongBow(), new FletchOakStaff(), new FletchOakShortBow(), new FletchOakStock(), new FletchOakWand(),
    new FletchWillowLongBow(), new FletchWillowStaff(), new FletchWillowShortBow(), new FletchWillowStock(), new FletchWillowWand(),
    new FletchWoodLongBow(), new FletchWoodStaff(), new FletchWoodShortBow(), new FletchWillowStock(), new FletchWoodWand()]
...
export function smithingRecipes() {
    ...
    new SmithBronzeAxe(), new SmithBronzeAxe2H(), new SmithBronzeBarrel(), new SmithBronzeBoots(), new SmithBronzeDagger(), new SmithBronzeDaggerOffHand(),
    new SmithBronzeGauntlets(), new SmithBronzeHatchet(), new SmithBronzeHelmet(), new SmithBronzeLegs(), new SmithBronzeLimbs(), new SmithBronzeMace(),
    new SmithBronzePickaxe(), new SmithBronzeShield(), new SmithBronzeSword(), new SmithBronzeSword2H(), new SmithBronzeTools(), new SmithBronzeTorso(),
    new SmithBronzeWarHammer(), new SmithBronzeWarHammer2H(),
    new SmithIronAxe(), new SmithIronAxe2H(), new SmithIronBarrel(), new SmithIronBoots(), new SmithIronDagger(), new SmithIronDaggerOffHand(),
    new SmithIronGauntlets(), new SmithIronHatchet(), new SmithIronHelmet(), new SmithIronLegs(), new SmithIronLimbs(), new SmithIronMace(),
    new SmithIronPickaxe(), new SmithIronShield(), new SmithIronSword(), new SmithIronSword2H(), new SmithIronTools(), new SmithIronTorso(),
    new SmithIronWarHammer(), new SmithIronWarHammer2H(),
    new SmithSteelAxe(), new SmithSteelAxe2H(), new SmithSteelBarrel(), new SmithSteelBoots(), new SmithSteelDagger(), new SmithSteelDaggerOffHand(),
    new SmithSteelGauntlets(), new SmithSteelHatchet(), new SmithSteelHelmet(), new SmithSteelLegs(), new SmithSteelLimbs(), new SmithSteelMace(),
    new SmithSteelPickaxe(), new SmithSteelShield(), new SmithSteelSword(), new SmithSteelSword2H(), new SmithSteelTools(), new SmithSteelTorso(),
    new SmithSteelWarHammer(), new SmithSteelWarHammer2H()]
...
export function farmingRecipes() {
    var farm = [new HarvestWheat(), new MilkCow(), new ShearSheep()]
    return farm;
}
...
export class MilkCow extends FarmingRecipe {
    constructor(name = "Harvest Wheat", level = 1, xp = 5, input = [{ Item: new Bucket(), Quantity: 1 }], output = { Item: new Milk(), Quantity: 1 }, failure = null) {
        super(name, level, xp, input, output, failure)
        this.Verb = "Milk"
    }
}
...
export class HarvestCrop extends FarmingRecipe {
    constructor(name, level, xp, input, output, failure) {
        super(name, level, xp, input, output, failure)
        this.Tool = new Sickle(); this.Verb = "Harvest"
    }
}
...
export function miningRecipes() {
    var mine = [new MineCoalOre(), new MineCopperOre(), new MineTinOre(), new MineIronOre(), new MineSulphur()]
    return mine;
}
