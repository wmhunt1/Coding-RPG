...
import { bareBack, bareFinger, bareNeck, bite, emptyOffHand, furFeet, furHands, furHead, furLegs, furTorso, hat, gloves, ratTail, rawRatMeat, shoes, sword, trousers, tunic, woodenShield, healingPotion, bronzeDagger, bareFist, bareHead, bareTorso, bareLegs, bareHands, bareFeet, woodenclub, loinCloth, dogCollar } from "./ItemsDB";
...
import { acrobaticsSkill, alchemySkill, athleticsSkill, axeSkill, barterSkill, blockSkill, bluntSKill, conjurationSkill, cookingSkill, craftingSkill, destructionSkill, enchantingSKill, farmingSkill, firemakingSkill, fishingSkill, fletchingSkill, heavyArmorSkill, huntingSkill, illusionSkill, lightArmorSkill, lockpickingSkill, longBladeSkill, mediumArmorSkill, miningSkill, persuationSkill, rangedSkill, restorationSkill, shortBladeSkill, smithingSkill, spearSkill, stealthSkill, survivalSkill, unArmedSkill, unArmoredSkill, woodcuttingSkill } from "./SkillsDB";
