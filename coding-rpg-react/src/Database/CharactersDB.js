import { noCondition } from "./ConditionsDB";
import { cleave,pierceArmor, rage} from "./AbilitiesDB";
import { bareBack, bareFinger, bareNeck, bite, emptyOffHand, furFeet, furHands, furHead, furLegs, furTorso, hat, gloves, ratTail, rawRatMeat, shoes, sword, trousers, tunic, woodenShield, healingPotion, bronzeDagger, bareFist, bareHead, bareTorso, bareLegs, bareHands, bareFeet, woodenclub, loinCloth } from "./ItemsDB";
...
import { cookingSkill, firemakingSkill, fishingSkill, fletchingSkill, miningSkill, smithingSkill, woodcuttingSkill } from "./SkillsDB";
