...
function Journal(props) {
    ...
    return (<div s>
        ...
        <div style = {{overflow: "scroll", marginRight: "25%", marginLeft:"25%", border: "solid"}}>
        ...
        {list === "Completed" ? <div>{completedQuestList.length > 0 ? <div>{completedQuestList}</div> : <div><h4>No Completed Quests</h4></div>}</div> : <div></div>}
        </div>
