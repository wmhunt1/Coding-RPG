...
function Map(props) {
    ...
    const [showAdjacentLocation, setShowAdjacentLocation] = useState(false)
    ...
    function updateShowAdjacentLocations(bool) {
        if (bool === true) {
            setShowAdjacentLocation(false)
        }
        else {
            setShowAdjacentLocation(true)
        }
    }
    ...
    return (<div>
        ...
        <div style={{ border: "solid", height: "300px" }}>
            ...
            <div>
                <div style={{ display: "inline-block", verticalAlign: "text-top", marginRight: ".1%", border: "solid", paddingLeft: "1%", paddingRight: "1%", height: "150px", width:"120px"}}>
